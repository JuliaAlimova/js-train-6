...
function copyObject(obj) {
  return { ...obj };
  // Використовуємо синтаксис деструктурізації {...animal} для створення нового об'єкта з тими ж властивостями
...
//     if (key == property) return `Property ${property} exists`;
//     else {
...
// Створіть два об'єкти planet1 та planet2 з полями   name: "Земля",radius: 6371,
...
console.log(addProperty(newArr));
